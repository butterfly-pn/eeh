...
CREATE TABLE IF NOT EXISTS `eeh`.`user` (
  ...
  `email_confirm` BINARY(1) NOT NULL,
  `scout_id` INT,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `eeh`.`user_membership` (
  ...
  CONSTRAINT `fk_user_membership_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `eeh`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_membership_usergroup1`
    FOREIGN KEY (`usergroup_id`)
    REFERENCES `eeh`.`usergroup` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `eeh`.`goal` (
  ...
  CONSTRAINT `fk_goal_characteristic1`
    ...
    REFERENCES `eeh`.`characteristic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `eeh`.`scout_membership` (
  ...
  CONSTRAINT `fk_scout_membership_scouting_troop1`
    ...
    REFERENCES `eeh`.`scouting_troop` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `eeh`.`scout_presence` (
  ...
  CONSTRAINT `fk_scout_presence_scout_meeting1`
    ...
    REFERENCES `eeh`.`scout_meeting` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
