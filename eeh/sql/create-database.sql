...
-- Table `eeh`.`status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eeh`.`status` (
...
CREATE TABLE IF NOT EXISTS `eeh`.`scout` (
  ...
  INDEX `fk_scout_status1_idx` (`status_id` ASC),
  CONSTRAINT `fk_scout_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `eeh`.`status` (`id_status`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `eeh`.`user_membership` (
  ...
  INDEX `fk_user_membership_status1_idx` (`status_id` ASC),
  ...
  CONSTRAINT `fk_user_membership_usergroup1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_membership_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `eeh`.`status` (`id_status`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `eeh`.`scout_team` (
  ...
  INDEX `fk_scout_team_status1_idx` (`status_id` ASC),
  CONSTRAINT `fk_scout_team_user1`
    FOREIGN KEY (`scoutmaster_user_id`)
    REFERENCES `eeh`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_scout_team_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `eeh`.`status` (`id_status`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `eeh`.`scouting_troop` (
  ...
  INDEX `fk_scouting_troop_status1_idx` (`status_id` ASC),
  CONSTRAINT `fk_scouting_troop_scout_team1`
    FOREIGN KEY (`scout_team_id`)
    REFERENCES `eeh`.`scout_team` (`id_scout_team`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_scouting_troop_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `eeh`.`status` (`id_status`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `eeh`.`scout_membership` (
  ...
  INDEX `fk_scout_membership_status1_idx` (`status_id` ASC),
  ...
  CONSTRAINT `fk_scout_membership_scouting_troop1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_scout_membership_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `eeh`.`status` (`id_status`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
